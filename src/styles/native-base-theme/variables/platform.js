...
export default {
  ...
  // Container
  containerDefaultBg: '#FFFFFF',

  // Footer
  footerHeight: isIphoneX ? 89 : 60,
  ...
  toolbarHeight: (platform === "ios" ? (isIphoneX ? 88 : 64) : 56) * 2.8,
  ...
  // Changed Variable
  listItemPadding: platform === "ios" ? 5 : 7,

  listNoteColor: "#939598",
  listNoteSize: 13,
